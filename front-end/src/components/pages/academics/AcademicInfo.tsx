...
const academicInfoSchema = z.object({
  ...
  institutionName: z
    ...
    .regex(
      /^[a-zA-Z\s]*$/,
      "Institution name must contain only letters and spaces"
    ),
});
...
export function AcademicInfo({ onNext }: AcademicInfoProps) {
  ...
  const isComplete =
    educationLevel && institutionName && Object.keys(errors).length === 0;
          ...
          <div className="px-6 py-8 sm:px-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger
                    className={`w-full px-4 py-2.5 bg-input border rounded-lg text-foreground focus:outline-none focus:ring-2 focus:border-primary transition ${
                      (initialValidationDone || touched.educationLevel) &&
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`w-full px-4 py-2.5 bg-input border rounded-lg text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:border-primary transition ${
                    (initialValidationDone || touched.institutionName) &&
            ...
            <div className="mt-6 p-4 bg-muted/50 border border-border rounded-lg">
              <p className="text-xs text-muted-foreground">
                This information helps us organize your courses and study plan
                effectively.
              </p>
            </div>
          </div>
